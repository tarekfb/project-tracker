  ...
  return (
    <>
      ...
      <div className="group z-10 w-full fixed flex flex-row justify-end space-x-4 lg:space-x-6 items-center text-white px-4 py-2 lg:py-4 lg:px-5 bg-col hover:bg-white hover:text-black">
        ...
        <Link href="/auth" className="text-3xl border border-black group-hover:border-black">
          <a>
      ...
      <main className='flex flex-col space-y-2'>
        <header>
          <ImageOverlay src={student} title={siteTitle} subtitle="Like trello, but worse" positioning="top-24 lg:top-40 left-5 lg:left-10">
